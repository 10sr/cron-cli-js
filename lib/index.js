...
function createMailTransporter(opts){
    ...
    console.log("Setting up email notification");
    console.log("Sender: " + SENDER_DEFAULT);
    console.log("Mailto: " + opts.mailto);
    var mailDefaults = {
        from: SENDER_DEFAULT,
        to: opts.mailto
    };
    ...
    if (opts.smtpHost || opts.smtpPort ||
        ...
        console.log("Use SMTP to send emails");
        ...
        console.log("Use sendmail to send emails");
        return nodemailer.createTransport({
            sendmail: true,
            newline: "unix"
        }, mailDefaults);
